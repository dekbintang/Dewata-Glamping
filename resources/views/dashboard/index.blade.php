...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="bg-gray-50 rounded-2xl p-5">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Reservasi Hari Ini</p>
        ...
        <div class="bg-gray-50 rounded-2xl p-5">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Tamu Check-in</p>
        ...
        <div class="bg-gray-50 rounded-2xl p-5">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Pendapatan Bulan Ini</p>
        ...
        <div class="bg-gray-50 rounded-2xl p-5">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Unit Tersedia</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
        <div class="lg:col-span-2 bg-gray-50 rounded-2xl p-5">
    ...
    <div class="bg-gray-50 rounded-2xl overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead>
                    <tr class="text-gray-400 text-xs uppercase tracking-wider border-b border-gray-200/50">
                        <th class="px-5 py-3 text-left font-medium">Kode Booking</th>
